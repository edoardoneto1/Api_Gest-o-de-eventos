...
from apps.events.api.v1.router import urlpatterns as events_urls  # <--- Importa a lista de URLs
...
api_v1_0_urls = [
    ...
    path("events/", include((events_urls, "events"), namespace="events")),  # <--- Inclui as rotas aqui
